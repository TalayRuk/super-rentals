...
export default Ember.Component.extend({
  ...
  actions: {
    ...
    saveRental1() {
      //create variable
      var params = { //like parameter to getter in #C to get info
        ...
        //**NOTE undefined is not a valid JSON type. It'll prevent the record from being written to Firebase & cause an error.
...
//**NOTE* saveRental1 collects data & sets them as values in a hash of keys w/ the same names.
